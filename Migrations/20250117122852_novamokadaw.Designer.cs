...
namespace ControleDeEstoque.API.Migrations
{
    ...
    [Migration("20250117122852_novamokadaw")]
    partial class novamokadaw
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleDeEstoque.API.Models.VendaModel.VendaModel", b =>
                {
                    ...
                    b.Property<Guid>("MetodoPagamento")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ControleDeEstoque.API.Models.VendaModel.VendaModel", b =>
                {
                    b.HasOne("ControleDeEstoque.API.Models.PagamentoModel.PagamentoModel", "Pagamento")
                        .WithMany()
                        .HasForeignKey("MetodoPagamento")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
